...
import { useDelete, useLikes } from '../hooks'
          ...
          <div className="flex mb-2">
            ...
            <div className="flex items-center justify-center">
              <button
                ...
                onClick={() => handleLikes({ title: elem.title, author: elem.author, url: elem.url, likes: elem.likes + 1 })}
              >
                Like
...
export default function BlogList({ list, user }) {
